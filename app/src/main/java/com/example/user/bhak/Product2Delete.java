...
public class Product2Delete extends AppCompatActivity {
    ...
    private void deletedata(){
        ...
        long row=db.delete(ProductContract.Product2Entry.TABLE_NAME, ProductContract.Product2Entry._ID+" = "+idInt,null);
        db.close();

...
public class Product3Catalog extends AppCompatActivity {

    ListView listView;
    Product3DbHelper mDbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product3_catalog);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);


        mDbHelper =new Product3DbHelper(this);
        mCartDb=new CartDbHelper(this);
        listView=(ListView)findViewById(R.id.list_product3);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(Integer.parseInt(current.getStock())>0) {
                    ...
                    if (row != -1)
                        Toast.makeText(Product3Catalog.this, "Item added to cart", Toast.LENGTH_LONG).show();
                    else
                        Toast.makeText(Product3Catalog.this, "Item cannot be added to cart", Toast.LENGTH_LONG).show();

                    SQLiteDatabase db1 = mDbHelper.getWritableDatabase();
                    String query = "update " + ProductContract.Product3Entry.TABLE_NAME
                            + " set stock=stock - 1 where " + ProductContract.Product3Entry._ID + " = " + current.getId();
                    db1.execSQL(query);
                }
                else {
                    Toast.makeText(Product3Catalog.this,"Out of stock",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void displayInfo(){
        ...
        String[] projection={
                ProductContract.Product3Entry._ID,
                ProductContract.Product3Entry.COLUMN_PRODUCT3_DESCRIPTION,
                ProductContract.Product3Entry.COLUMN_PRODUCT3_COLOR,
                ProductContract.Product3Entry.COLUMN_PRODUCT3_PRICE,
                ProductContract.Product3Entry.COLUMN_PRODUCT3_STOCK
        };

        Cursor cursor=db.query(
                ProductContract.Product3Entry.TABLE_NAME,
                projection,
                null,
                null,
                null,
    ...
    public void priceHightoLow(){
        ...
        Cursor cursor=db.query(
                ...
                null,
                null,
                ProductContract.Product3Entry.COLUMN_PRODUCT3_PRICE+" DESC"
        );
    ...
    public void priceLowToHigh(){
        ...
        Cursor cursor=db.query(
                ...
                null,
                null,
                ProductContract.Product3Entry.COLUMN_PRODUCT3_PRICE+" ASC"
        );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_insert_data:
                Intent i7=new Intent(this,Product3Editor.class);
                startActivity(i7);
                return true;
            ...
            case R.id.action_delete_entries:
                Intent i1=new Intent(this,Product3Delete.class);
                startActivity(i1);
                return true;

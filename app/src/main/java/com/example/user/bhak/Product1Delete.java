...
public class Product1Delete extends AppCompatActivity {
    ...
    private void deletedata(){
        ...
        long row=db.delete(ProductContract.Product1Entry.TABLE_NAME, ProductContract.Product1Entry._ID+" = "+idInt,null);
        db.close();
